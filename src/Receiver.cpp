...
void Receiver::receive() {
    ...
    */
    ...
    while(true){
        ...
        // Print the message
        this->printMessage(encodedMessage);
    }
...
void Receiver::printMessage(struct EncodedMessage message) {
    /*
        @ return void
        Print the message
    */
    ...
    if (message.quality == "Warning") {
        std::cout << "\033[33m"; 
    } else if (message.quality == "Alarm") {
        std::cout << "\033[31m"; 
    }


    std::cout << "Receiver nr." << this->id << " - Sensor Type: " << message.type << ", ID: " << message.id << ", Value: " << message.value << ", Encoding Type: " << message.encoderType << ", Quality: " << message.quality << std::endl;
